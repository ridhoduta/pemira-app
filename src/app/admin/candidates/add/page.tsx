  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
      <div className="bg-brand-600 px-6 py-8">
        ...
        <p className="text-brand-100 text-center mt-2">Fill in the details to register a new candidate for Pemira</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="p-8 space-y-6">
        <div>
          ...
          <input
            type="text"
            required
            className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-colors text-black"
            ...
            <div className="flex-1">
              <input
                ...
                className="w-full text-sm text-gray-500
                  ...
                  file:bg-indigo-50 file:text-brand-700
                  hover:file:bg-brand-100 transition-all cursor-pointer"
              />
            </div>
            {formData.image && (
              <div className="relative w-24 h-24 rounded-xl overflow-hidden border-2 border-brand-100">
        ...
        <div className="flex gap-4 pt-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="flex-1 px-6 py-3 rounded-lg bg-brand-600 text-white font-semibold hover:bg-brand-700 transition-colors disabled:opacity-50"
          >
